...
brought to you by   <font color=\"#800000\">Pyratz</font></span>
...
<td colspan="3" height="190" bordercolor="#E8E8E8" bgcolor="#E8E8E8"><font size="-1" face="Verdana, Arial, Helvetica, sans-serif"> 
      ...
      <td width="10%" height="22" bordercolor="#E8E8E8" bgcolor="#E8E8E8">
        ...
        <div align="right"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">Links:</font></div>

      </td>

      <td colspan="3" bordercolor="#E8E8E8" bgcolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">

        <textarea name="links" cols="120" rows="5"><?=$links;?></textarea>
...
$rrandom = "<FONT style='FONT-SIZE: 3px; FONT-FAMILY: Arial' color=#fffbff>".$randomString."</FONT>";
...
$rrandom1 = "<FONT style='FONT-SIZE: 3px; FONT-FAMILY: Arial' color=#fffbff>".$randomString."</FONT>";

$randomString = '';
for ($j = 0; $j < $rmin; $j++) {
        $randomString .= $characters[rand(0, $charactersLength - 1)];
    }
$rrandom2 = "<FONT style='FONT-SIZE: 3px; FONT-FAMILY: Arial' color=#fffbff>".$randomString."</FONT>";

$randomString = '';
for ($j = 0; $j < $rmin; $j++) {
        $randomString .= $characters[rand(0, $charactersLength - 1)];
    }
$rrandom3 = "<FONT style='FONT-SIZE: 3px; FONT-FAMILY: Arial' color=#fffbff>".$randomString."</FONT>";

$rhl = "<FONT style='FONT-SIZE: 3px; FONT-FAMILY: Arial' color=#f1f0f0>".$randomString."</FONT>";

$randomString = '';
for ($j = 0; $j < $rmin; $j++) {
        $randomString .= $characters[rand(0, $charactersLength - 1)];
    }
$rrandom4 = "<FONT style='FONT-SIZE: 3px; FONT-FAMILY: Arial' color=#fffbff>".$randomString."</FONT>";

$randomString = '';
for ($j = 0; $j < $rmin; $j++) {
        $randomString .= $characters[rand(0, $charactersLength - 1)];
    }
$rrandom5 = "<FONT style='FONT-SIZE: 3px; FONT-FAMILY: Arial' color=#fffbff>".$randomString."</FONT>";
...
$ll = $ll + 1;
                ...
                $to = ereg_replace(" ", "", $to);
				$rlink = ereg_replace(" ", "", $rlink);
				$c1 = strval($c1);
				$c2 = strval($c2);
				$c3 = strval($c3);

                $message1 = ereg_replace("&cemail&", $to, $message);
				$message1 = ereg_replace("&cmid&", $cmid, $message1);
				$message1 = ereg_replace("&crid&", $crid, $message1);
				$message1 = ereg_replace("&c1&", $c1, $message1);
				$message1 = ereg_replace("&c2&", $c2, $message1);
				$message1 = ereg_replace("&c3&", $c3, $message1);
				$message1 = ereg_replace("&rrandom&", $rrandom, $message1);
				$message1 = ereg_replace("&rrandom1&", $rrandom1, $message1);
				$message1 = ereg_replace("&rrandom2&", $rrandom2, $message1);
				$message1 = ereg_replace("&rrandom3&", $rrandom3, $message1);
				$message1 = ereg_replace("&rrandom4&", $rrandom4, $message1);
				$message1 = ereg_replace("&rrandom5&", $rrandom5, $message1);
				$message1 = ereg_replace("&rlink&", $rlink, $message1);
				$message1 = ereg_replace("&rimage&", $rlink, $message1);
				$message1 = ereg_replace("&rhl&", $rhl, $message1);

                $subject1 = ereg_replace("&cemail&", $to, $subject);
				$subject1 = ereg_replace("&crid&", $crid, $subject1);
				$subject1 = ereg_replace("&crid2&", $crid2, $subject1);
			
                $qx=$x+1;
                print "Line $qx . Sending mail to $to with link $rlink.......";
